...
object CountryHelper {
  ...
  def convertIso2ToIso3(iso2: String) : String = {

    val iso2ToISO3 = Map("AF" -> "AFG", "AX" -> "ALA", "AL" -> "ALB", "DZ" -> "DZA", "AS" -> "ASM", "AD" -> "AND",
      "AN" -> "ANT", "AO" -> "AGO", "AI" -> "AIA", "AQ" -> "ATA", "AG" -> "ATG", "AR" -> "ARG", "AM" -> "ARM",
      ...
      "BV" -> "BVT", "BR" -> "BRA", "IO" -> "IOT", "VG" -> "VGB", "BN" -> "BRN", "BG" -> "BGR",
      "BF" -> "BFA", "BI" -> "BDI", "CI" -> "CIV", "KH" -> "KHM", "CM" -> "CMR", "CA" -> "CAN",
      "CV" -> "CPV", "KY" -> "CYM", "CF" -> "CAF", "TD" -> "TCD", "CL" -> "CHL", "CN" -> "CHN",
      "CX" -> "CXR", "CC" -> "CCK", "CO" -> "COL", "KM" -> "COM", "CG" -> "COG", "CK" -> "COK",
      "CR" -> "CRI", "HR" -> "HRV", "CU" -> "CUB", "CW" -> "CUW", "CY" -> "CYP", "CZ" -> "CZE",
      "CD" -> "COD", "DK" -> "DNK", "DJ" -> "DJI", "DM" -> "DMA", "DO" -> "DOM", "EC" -> "ECU",
      ...
      "CH" -> "CHE", "SY" -> "SYR", "TW" -> "TWN", "TJ" -> "TJK", "TH" -> "THA", "TL" -> "TLS",
      "TG" -> "TGO", "TK" -> "TKL", "TO" -> "TON", "TT" -> "TTO", "TN" -> "TUN", "TR" -> "TUR",
      "TM" -> "TKM", "TC" -> "TCA", "TV" -> "TUV", "UG" -> "UGA", "UA" -> "UKR", "AE" -> "ARE",
      "GB" -> "GBR", "TZ" -> "TZA", "US" -> "USA", "UM" -> "UMI", "UY" -> "URY", "VI" -> "VIR",
      "UZ" -> "UZB", "VU" -> "VUT", "VE" -> "VEN", "VN" -> "VNM", "WF" -> "WLF", "XK" -> "XKX",
