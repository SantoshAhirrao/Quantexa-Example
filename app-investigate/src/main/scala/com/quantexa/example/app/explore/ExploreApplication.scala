package com.quantexa.example.app.explore
...
class ExploreApplication extends WebSecurityConfigurerAdapter {
  ...
  def api = new Docket(DocumentationType.SWAGGER_2)
    ...
    .apiInfo(new ApiInfo(
      "Explore app REST API",
      "Explore app endpoints",
      "1.0",
      "Terms of service",
...
object ExploreApplication {
  def main(args: Array[String]): Unit = {
    QuantexaSpringApplication(classOf[ExploreApplication], args)
  }
}
