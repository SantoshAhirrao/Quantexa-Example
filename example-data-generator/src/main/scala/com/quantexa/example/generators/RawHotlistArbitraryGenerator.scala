...
/**
  * This generates a template arbitrary for the RawHotlist class
  ...
  */
object RawHotlistArbitraryGenerator extends NoConfigSparkScript {

  val name = "RawHotlistArbitraryGenerator"
  ...
  protected def run(spark: SparkSession, logger: Logger, args: Seq[String],
    ...
    ArbitraryUtils.printCaseClassSchema[HotlistRaw]
  }
}
