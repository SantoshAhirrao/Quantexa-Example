package com.quantexa.example.app.resolve
...
class ResolveScoreApplication extends WebSecurityConfigurerAdapter {
...
object ResolveScoreApplication {
  def main(args: Array[String]): Unit = {
    QuantexaSpringApplication(classOf[ResolveScoreApplication], args)
  }
}
