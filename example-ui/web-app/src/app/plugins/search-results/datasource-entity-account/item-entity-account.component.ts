...
@Component({
    selector: 'qe-search-item-entity-account',
    templateUrl: './item-entity-account.component.html',
    styleUrls: ['./item-entity-account.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ItemEntityAccountComponent extends ResultItemBaseComponent {
    dataSource = 'account';
